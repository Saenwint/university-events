...
#### 2.1. Роли пользователей
    ...
    Администратор:
        ...
        -[x] Создание/редактирование мероприятий 
        ...
        -[x] Назначение "ЛЭТИ-коинов" за посещение.

    Студент:

        -[x] Просмотр мероприятий, запись через кнопку "Участвовать".
...
#### 2.4. ЛЭТИ-коины
    ...
    -[x] Начисляются после сканирования QR-кода системой.

    -[x] Отображаются в профиле студента.
